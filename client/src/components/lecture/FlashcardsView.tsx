           ...
           {!activeCard ? (
             activeMode === "spaced" && filteredCards.length === 0 ? (
               ...
               <div className="text-center space-y-4">
                  ...
                  <h3 className="text-2xl font-black text-slate-900">{language === "ar" ? "أحسنت! اكتمل" : "All Done!"}</h3>
                      ...
                      <AnimatePresence mode="wait">
                         {isFlipped ? (
                           ...
                           <div className="flex gap-4 opacity-40 select-none grayscale pt-12">
                              <span className="px-3 py-1 bg-slate-100 rounded text-[10px] font-bold text-slate-400">{language === "ar" ? "مسافة: قلب البطاقة" : "SPACE FLIP CARD"}</span>
                              <span className="px-3 py-1 bg-slate-100 rounded text-[10px] font-bold text-slate-400">{language === "ar" ? "١-٤ تقييم الإجابة" : "1-4 RATE ANSWER"}</span>
                              <span className="px-3 py-1 bg-slate-100 rounded text-[10px] font-bold text-slate-400">{language === "ar" ? "ESC خروج" : "ESC EXIT MODULE"}</span>
                           </div>
                         )}
                      </AnimatePresence>
                   </div>
