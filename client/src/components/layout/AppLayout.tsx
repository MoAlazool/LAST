import { Sidebar, SidebarContent, LectureNav } from "./Sidebar";
...
export function AppLayout({ children, currentTab, lectureNav }: { children: ReactNode, currentTab?: string, lectureNav?: LectureNav }) {
