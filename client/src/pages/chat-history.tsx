...
export default function ChatHistoryPage() {
  ...
  const t = {
    ...
    subtitle: language === "ar" ? "جميع محادثاتك مع الوكيل الذكي مرتبة حسب المحاضرة" : "All your AI Agent conversations, organized by lecture",
    search: language === "ar" ? "ابحث في المحادثات..." : "Search conversations...",
    empty: language === "ar" ? "لا توجد محادثات بعد" : "No conversations yet",
    emptyHint: language === "ar" ? "ابدأ التحدث مع الوكيل الذكي في أي محاضرة" : "Start chatting with the AI Agent inside any lecture",
