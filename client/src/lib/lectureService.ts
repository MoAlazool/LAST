...
function firestoreToLecture(docData: any, id: string): Lecture {
  return {
    ...
    medical: docData.medical || undefined,
    engineering: docData.engineering || undefined,
    conceptMap: docData.conceptMap || undefined,
...
function lectureToFirestore(lecture: Partial<Lecture>): any {
  ...
  if (lecture.medical !== undefined && lecture.medical !== null) data.medical = lecture.medical;
  if (lecture.engineering !== undefined && lecture.engineering !== null) data.engineering = lecture.engineering;
  if (lecture.conceptMap !== undefined && lecture.conceptMap !== null) data.conceptMap = lecture.conceptMap;
...
function updatesToFirestore(updates: Partial<Lecture>): any {
  ...
  if (updates.medical !== undefined && updates.medical !== null) data.medical = updates.medical;
  if (updates.engineering !== undefined && updates.engineering !== null) data.engineering = updates.engineering;
  if (updates.conceptMap !== undefined && updates.conceptMap !== null) data.conceptMap = updates.conceptMap;
